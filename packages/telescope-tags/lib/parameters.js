 ...
 * and options arguments for the subscriptions's Categories.find()
 * @param {Object} terms
 */
Categories.getSubParams = function (terms) {
  ...
  var parameters = Telescope.utils.deepExtend(true, {}, Categories.views.baseParameters);

  // get query parameters according to current view
  if (typeof Categories.views[terms.view] !== 'undefined')
    parameters = Telescope.utils.deepExtend(true, parameters, Categories.views[terms.view](terms));
